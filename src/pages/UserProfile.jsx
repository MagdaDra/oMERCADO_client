			...
			<div className='flex flex-wrap'>
				{servicesOffered.map((service) => {
					...
					return (
						<div
							key={service._id}
							className='rounded-3xl bg-white text-gray-900 overflow-hidden shadow-lg shadow-gray-200 flex-col justify-start h-[415px] w-96 mb-10 ml-4 mr-4 mt-10'>
							<div
								className={'h-3/5'}
								style={{
							...
							<div className='pt-4 pl-3 md:pl-6 md:pr-2 md:py-6 flex justify-between'>
								<div className='mr-2'>
					...
					return (
						<div
							...
							<div className='pt-4 pl-3 md:pl-6 md:pr-2 md:py-6 flex justify-between'>
								...
								<div className='mt-[72px] mr-1 md:mt-2'>
									{item.service.isActive ? (
										<Link to={`/services/${item.service._id}`}>
											<button className='text-white text-sm items-center rounded-full justify-center p-2 w-32 md:w-32 border bg-black hover:bg-[#9a9a9a]'>
												Go to service
											</button>
										</Link>
									) : (
