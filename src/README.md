...
The app is an e-commerce store for services with a customer and seller view. Sellers can add their services to sell and control their stock. Customers can purchase services and view their past transactions. A client can have both 'customer' and 'seller' profile.
